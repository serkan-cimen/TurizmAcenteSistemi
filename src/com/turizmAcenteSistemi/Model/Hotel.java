...
import com.turizmAcenteSistemi.Wiew.HotelAddGUI;
import com.turizmAcenteSistemi.Wiew.HotelGUI;
...
public class Hotel {
    ...
    public static boolean add(String name, String address, String city, String region, String email, String phone_num, String star, String boarding_house, ArrayList<String> serviceSpec) {
        String sql = "INSERT INTO hotel (name, address, email, phone_num, boarding_house, city, region, star, service_spec) VALUES (?,?,?,?,?,?,?,?,?)";
        try {
